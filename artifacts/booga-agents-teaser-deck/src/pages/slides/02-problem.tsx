      ...
      <div className="mt-[6vh] grid grid-cols-3 gap-[2vw]">
        <div className="rounded-[1.2vw] border border-stone/50 bg-white/60 p-[2vw]">
          ...
          <p className="mt-[1.2vh] text-[1.1vw] leading-snug text-muted">
            Answers buried across thousands of folders, unfindable in time.
          </p>
        </div>
        ...
        <div className="rounded-[1.2vw] border border-stone/50 bg-white/60 p-[2vw]">
          ...
          <p className="mt-[1.2vh] text-[1.1vw] leading-snug text-muted">
            Your best people searching and drafting by hand instead of advising.
          </p>
        </div>
        ...
        <div className="rounded-[1.2vw] border border-stone/50 bg-white/60 p-[2vw]">
          ...
          <p className="mt-[1.2vh] text-[1.1vw] leading-snug text-muted">
            Every workaround — forwarding files, public chatbots — is an
            exposure.
          </p>
        </div>
      </div>
