export default function Platform() {
  return (
    <div className="slide relative flex flex-col justify-center bg-bg px-[7vw] py-[8vh]">
      ...
      <h2 className="max-w-[64vw] font-display text-[3vw] font-bold leading-[1.08] tracking-tight text-text">
        Connect. Understand. Act —{" "}
        <span className="text-accent">all inside your own walls.</span>
      </h2>
      <p className="mt-[2.5vh] max-w-[58vw] text-[1.25vw] font-light leading-snug text-muted">
        Booga Agents reads your documents, organizes them automatically, and
        then agents do the real work — in an environment that's isolated,
        governed, and yours.
      </p>
        ...
        <div className="flex items-stretch gap-[1.5vw]">
          <div className="flex-1 rounded-[1vw] bg-bg p-[1.8vw]">
            ...
            <p className="mt-[1.2vh] text-[1.15vw] font-medium leading-snug text-text">
              Plug into SharePoint and Microsoft 365 — one-way, read-only.
            </p>
          </div>
          ...
          <div className="flex-1 rounded-[1vw] bg-bg p-[1.8vw]">
            ...
            <p className="mt-[1.2vh] text-[1.15vw] font-medium leading-snug text-text">
              Every document — scanned, legacy, multi-language — made searchable.
            </p>
          </div>
          <div className="flex items-center font-display text-[2vw] font-light text-accent">→</div>
          <div className="flex-1 rounded-[1vw] bg-bg p-[1.8vw]">
            ...
            <p className="mt-[1.2vh] text-[1.15vw] font-medium leading-snug text-text">
              Agents draft replies and documents, described in plain English.
            </p>
          </div>
        </div>
      </div>
